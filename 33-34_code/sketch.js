...
/*
Credit: https://p5js.org/examples/simulate-smokeparticles.html
Note: a part of Dan Shiffman's SmokeParticleSystem example originally for Processing.
...
function preload() {
    particle_texture = loadImage("assets/particle_texture_gold.png");
}
...
function draw() {
    ...
    let dx = map(mouseX, 0, width, -3, 3);
    let dy = map(mouseY, 0, height, -3, 3);
...
let Particle = function (pos, img_) {
    ...
    let vx = randomGaussian() * 5;
    let vy = randomGaussian() * 5 - 1.0;
